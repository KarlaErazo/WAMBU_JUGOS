...
router.post("/obtenerPath", controller.paymentDetail.obtenerPath);
...
router.post("/gestionEmpresa", controller.company.gestionEmpresa);
...
router.post("/gestionFormaPago", controller.paymentmethod.gestionFormaPago);
...
router.post('/enviarEmailContacto', controller.email.enviarEmailContacto);
