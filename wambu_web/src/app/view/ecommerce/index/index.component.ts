  ...
  public listarCarrusel() {
    ...
    this.conexion.get("listarCarrusel", "").subscribe(
      (res: any) => {
        ...
        this.carrusel.primero.foto = 'assets/img/productos/' + res.resultado[0].foto;
        this.carrusel.segundo.descripcion = res.resultado[1].descripcion;
        this.carrusel.segundo.foto = 'assets/img/productos/' + res.resultado[1].foto;
        this.carrusel.tercero.descripcion = res.resultado[2].descripcion;
        this.carrusel.tercero.foto = 'assets/img/productos/' + res.resultado[2].foto;
      },
      err => {
        console.log(err);
      }
